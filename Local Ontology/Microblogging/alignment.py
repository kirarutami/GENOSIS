...
# Membaca file CSV
o1 = pd.read_csv('D:\Dokumentasi\thesis\Microblogging\output_object_properties.csv', delimiter=',')
o2 = pd.read_csv('D:\Dokumentasi\thesis\Microblogging\OP-mf.csv', delimiter=',')
...
results_df.to_csv('new_ontology_alignment_tokenized_ratio_results.csv', index=False)
